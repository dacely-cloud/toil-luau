...
for (const name of ['Model', 'App', 'Persistence', 'Audio', 'Layout', 'Icons', 'LateGame', 'Economy', 'Social', 'EmpireStore', 'EmpireService', 'CharityStore', 'CharityService']) fs.copyFileSync(path.join(game, name + '.luau'), path.join(stage, 'CookieClicker', name + '.luau'));
